...
| Project image assets | `Assets/_Project/Images` | Images in this project folder are either created manually by GameKit project authors or AI-generated by GameKit project authors using ChatGPT Images 2.0. Manual project-authored images are covered by the root project license. AI-generated image output is subject to OpenAI terms and policies: https://openai.com/policies/row-terms-of-use/, https://openai.com/policies/usage-policies/. |
